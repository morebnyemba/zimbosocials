...
<div style="max-width:640px;margin:0 auto;padding:24px;">
    <div style="background:linear-gradient(90deg,#059669,#f59e0b,#dc2626);padding:18px 22px;border-radius:14px;color:#fff;font-weight:700;letter-spacing:.04em;">
        {{ $brand }}
    </div>

    <div style="margin-top:16px;background:#ffffff;border:1px solid #e5e7eb;border-radius:14px;padding:22px;">
        ...
        @if(($template ?? '') === 'reset_password' && !empty($payload['action_url']))
            <p style="margin:20px 0 0;">
                <a href="{{ $payload['action_url'] }}" style="display:inline-block;background:#111827;color:#fff;text-decoration:none;padding:10px 16px;border-radius:10px;font-weight:700;">
